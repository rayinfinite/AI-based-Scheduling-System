...
public class BaseExcelReaderTest {
    ...
    void testReadExcel() throws IOException {
        // 获取测试 Excel 文件资源
        URL resource = getClass().getClassLoader().getResource("test_data.xlsx"); // test_data.xlsx 放在 test/resources 目录下
        ...
        assertEquals(3, dataList.size()); // 假设 test_data.xlsx 有 3 行数据
